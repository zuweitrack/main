...
public class TypicalGoals {
    ...
    public static final Goal ALICE = new GoalBuilder().withCompletion(false)
            .withEndDateTime("").withGoalText("stay fit").withImportance("1")
            .withStartDateTime.build();
    ...
    // Manually added - Person's details found in {@code GoalCommandTestUtil}
