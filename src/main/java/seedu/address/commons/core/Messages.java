...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_DATE_FORMAT =
            "Start Date cannot be later than End Date! End Date cannot be earlier than current date! \n%1$s";
    public static final String MESSAGE_INVALID_PERSON_DISPLAYED_INDEX = "The person index provided is invalid";
    public static final String MESSAGE_INVALID_GOAL_DISPLAYED_INDEX = "The goal index provided is invalid";
    public static final String MESSAGE_INVALID_REMINDER_TEXT_DATE = "The reminder text or start date provided is invalid";
