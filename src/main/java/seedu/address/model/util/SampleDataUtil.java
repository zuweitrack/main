    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            ...
            new Person(new Name("Royce Lew"), new Phone("93265932"), new Birthday("10/04/1996"),
                    new LevelOfFriendship("10"), new UnitNumber("#02-021"), getCcaSet(),
            ...
            new Person(new Name("Kaden Yeo"), new Phone("82350332"), new Birthday("28/03/2001"),
                    ...
                    EMPTY_MEET_DATE, getTagSet("friends")),
            new Person(new Name("Matthew Chiang"), new Phone("92624417"), new Birthday("2/04/1995"),
                    new LevelOfFriendship("5"), new UnitNumber("#20-43"), getCcaSet("Anime Club"),
                    EMPTY_MEET_DATE, getTagSet("classmate")),
            new Person(new Name("Loh Sin Yuen"), new Phone("92624417"), new Birthday("2/05/1995"),
                    new LevelOfFriendship("10"), new UnitNumber("#03-63"), getCcaSet("dance"),
                    EMPTY_MEET_DATE, getTagSet("schoolmate")),
            new Person(new Name("Florence Chiang"), new Phone("92624417"), new Birthday("2/06/1995"),
            ...
            new Person(new Name("Daniel Low"), new Phone("92624417"), new Birthday("12/04/1995"),
                    new LevelOfFriendship("9"), new UnitNumber("#7-473"), getCcaSet("Muay Thai"),
            ...
            new Person(new Name("Amanda Soh"), new Phone("92624417"), new Birthday("2/12/1995"),
                    new LevelOfFriendship("1"), new UnitNumber("#24-579"), getCcaSet("Computing club", "Anime Club"),
                    EMPTY_MEET_DATE, getTagSet("exgirlfriend")),
            new Person(new Name("Marlene Koh"), new Phone("92624417"), new Birthday("2/7/1997"),
                    new LevelOfFriendship("10"), new UnitNumber("#02-222"), getCcaSet("Pool"),
                    EMPTY_MEET_DATE, getTagSet("closefriend")),
            new Person(new Name("Johnny Depp"), new Phone("92624417"), new Birthday("2/12/1994"),
                    new LevelOfFriendship("10"), new UnitNumber("#01-346"), getCcaSet("Pool"),
                    EMPTY_MEET_DATE, getTagSet("malafriend")),
            new Person(new Name("Aditya"), new Phone("92624417"), new Birthday("2/04/1998"),
                    new LevelOfFriendship("10"), new UnitNumber("#6-43"), getCcaSet(),
                    EMPTY_MEET_DATE, getTagSet("malafriend")),
            new Person(new Name("Fuad"), new Phone("92624417"), new Birthday("20/04/1995"),
                    new LevelOfFriendship("5"), new UnitNumber("#6-43"), getCcaSet("Floorball"),
                    EMPTY_MEET_DATE, getTagSet("colleagues"))
        };
    }
