...
1. User requests to add a meet up date on a certain date with a student using his index
...
=== Use case: Show students of a particular level of friendship
*MSS*
+
1. User requests to show student by level of friendship using numerical values.
...
[none]
* 2a. The list has all students with level of friendship that matches input values
+
Use case ends.
