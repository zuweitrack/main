...
|`* * *` |user |edit a detail I added |

|`* * *` |user |set a level of friendship with a specific person |maintain my frienships depending on a priority system set by myself

|`* * *` |user |edit details of my contacts |stay updated with the current details of my friends

|`* *` |user |undo a command I entered |undo a wrong command that I entered

|`* *` |user |redo a command I entered |redo when I want to undo my "undo" command
